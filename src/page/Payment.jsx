...
export default function Payment() {
  ...
  return (
    <div className='content-center bg-red-80 min-h-full max-h-full justify-items-center pt-20'>
      ...
      <div className='shadow-[0px_0px_20px_2px] shadow-black/20 rounded-2xl w-1/2 p-5 m-5'>
        <div className='text-white grid grid-cols-[190px_1fr] grid-rows-3 p-3 rounded-xl  mb-5 shadow-[0px_0px_20px_2px] shadow-black/20 bg-amber-400/90'>
          ...
          <form>
            ...
            <div>
              ...
              <div className='grid grid-rows-4 mt-2'>
                <FiMap className='absolute ml-148 mt-2.5 text-2xl'/>
                ...
                <FiMap className='absolute ml-148 mt-25 text-2xl'/>
                <input type="text" placeholder='Type your location or search in map' className='relative bg-black/10 rounded-xl h-11 pl-4' />
              ...
              <div>
                ...
                <div className='grid grid-rows-2 mt-2'>
                  ...
                  <input type="number" placeholder='Cash' className='bg-black/10 rounded-xl h-11 pl-4 mb-5 ' />
                </div>
              </div>
